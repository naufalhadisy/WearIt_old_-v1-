...
$s = "select * from donor where email = '$email'";
...
if (isset($_POST["login"])) {
  if ($num == 1) {
    echo "<script>alert('Account already exist')</script>";
      ...
      $reg = "insert into donor (name, phonenum, email, password) values ('$name', '$phonenum', '$email', MD5('$password'))";
      mysqli_query($con, $reg);
      echo "<script>alert('Registration Successful')</script>";
      echo "<script>location.href='donor_signin.php'</script>";
      header('Location:donor_signin.php');
  }
}
?>
...
<meta charset="UTF-8">
  ...
  <title>WearIt - Donor Sign Up</title>
  </head>
<body>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Sign Up as Donor</p>
              <form method="post">
